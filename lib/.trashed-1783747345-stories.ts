...
const DEFAULT_AUTHOR = {
  ...
  bio: 'Seraphine Aishat is a storyteller and ghostwriter based in Accra, Ghana. She writes at the intersection of love, identity, and the African everyday — crafting narratives that breathe.',
  avatar: '/images/seraphine-avatar.jpg',
}

// ─── Data layer ────────────────────────────────────────────────────────────
// To swap to Sanity CMS later:
// 1. Install @sanity/client
// 2. Replace getStoryBySlug / getAllStories with GROQ queries
// 3. Keep the same return shape (Story / StoryMeta[])
